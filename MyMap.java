...
public class MyMap {
	public static void main(String []args) {
		...
		map.put(1002, "Mamata");
		map.put(1003, "Pooja");
		map.put(1004,"Nisargha");
		map.put(1004, "Nisargha1");
		System.out.println(map.get(1001));
		Set<Integer>key=map.keySet();
		for(Integer key:keys) {
			System.out.println("key"+key+"value"+map.get(key));
			System.out.println(map.contains("Shweta"));
			System.out.println(map.containsValue("Shweta"));
			Set<Map.Entry<Integer,String, V>>key = map.entrySet();
			for(Map.Entry<Integer,String, V>m:key) {
